...
const ClassSections: React.FC = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Target each grid specifically to ensure clean triggers
  ...
  const classSets = [
    {
      ...
      featuredImage: "https://i.postimg.cc/vZVqPzNZ/IMG-20260130-WA0014.jpg",
      classes: [
    ...
    },
    {
      ...
      featuredImage: "https://i.postimg.cc/7LQkgXGb/IMG-20260129-WA0004.jpg",
      classes: [
